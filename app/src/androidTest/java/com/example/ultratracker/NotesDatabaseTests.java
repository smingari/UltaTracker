...
public class NotesDatabaseTests {
    ...
    public void setUp() throws Exception {
        ...
        t1 = LocalTime.of(2021, 4, 20); // format is 2021-04-20
        t2 = LocalTime.of(2021, 5, 21); // format is 2021-04-20
        t3 = LocalTime.of(2021, 6, 22); // format is 2021-04-20
        t4 = LocalTime.of(2021, 7, 23); // format is 2021-04-20
    ...
    public void editReminder() {
        ...
        Reminder newN = new Reminder("Edit", d2.toString(), t2.toString(),"Edit", r1.getKey());
        ...
        assertEquals("Verify original", t2.toString(),  rl1.get(0).getTime());
